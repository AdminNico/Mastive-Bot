  ...
  run: async (client, message, args, config) => {
    ...
    if(command[1] == undefined){
      const embed = new Discord.RichEmbed()
          ...
          .addField('**Main Commands**', '`avatar`, `cmd-permissions`, `fuser`, `help`, `mcstatus`, `report`, `serverinfo`, `stats`, `sysinfo`, `userinfo`')
          .addField('**NSFW Commands**', '`ass`, `hentai`, `meme`, `nudes`, `porngif`, `pussy`')
